...
$(document).ready(function () {
    ...
    var store_data = function () {
        ...
        $("#TotalMoney").val((total * 0.01).toFixed(2));
        $('#EarnM').html(total_term + (total * 0.01).toFixed(2) + label_currency);
    };
    ...
    var increase_value = function () {
        $('#total_value').html((total * 0.01).toFixed(2) + label_currency);
    };

    var show_last = function () {
        $('#last_value').html((last_win * 0.01).toFixed(2) + label_currency);
    };

    var current_value = function () {
        $('#Current_value').html((current_win * 0.01).toFixed(2) + label_currency);
    };
